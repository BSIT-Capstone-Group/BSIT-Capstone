/*
 * Date Created: Saturday, June 26, 2021 9:01 PM
...
namespace Ph.Com.CoDe_A.Lakbay.Utilities {
    ...
    public virtual Mode OutlineMode {
    ...
    public virtual void LoadSmoothNormals() {
    ...
    public virtual List<Vector3> SmoothNormals(Mesh mesh) {
