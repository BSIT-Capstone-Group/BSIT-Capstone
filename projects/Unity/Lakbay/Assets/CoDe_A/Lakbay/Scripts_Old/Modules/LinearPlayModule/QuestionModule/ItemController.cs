...
using CoDe_A_Old.Lakbay.Modules.GameModule;
using TMPro;

namespace CoDe_A_Old.Lakbay.Modules.LinearPlayModule.QuestionModule {
    [System.Serializable]
    ...
    public class ItemController : MonoBehaviour {
        public static readonly float TIMER_ADDITIONAL_TIME = 8.0f;
